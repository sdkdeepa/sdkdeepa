...
1. June - React Animation
2. September - JS Summit PWA build and deploy

# 2023

1. June - How to cook Project Fugu Api's ?
2. May - Build an app with three in one - Flutter, PWA and Firebase - https://gdg.community.dev/events/details/google-gdg-waterloo-presents-build-and-deploy-flutter-pwa-to-firebase/
